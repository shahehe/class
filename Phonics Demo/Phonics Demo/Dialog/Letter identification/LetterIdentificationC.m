...
#import "LetterIdentificationC.h"
#import "CCAnimation+Helper.h"
#import "AnimatedSprite.h"

@implementation LetterIdentificationC
{
    // objects , weak ref
...
-(void) initLetterPic
{
    if ([self fileExistsInProject:@"littleLetterPic.png"] && ([self fileExistsInProject:@"littleLetterPicWriting.png"]))
    {
        littleLetterPic = [CCSprite spriteWithFile:@"littleLetterPic.png"];
        littleLetterPicWriting = [CCSprite spriteWithFile:@"littleLetterPicWriting.png"];
    ...
    if ([self fileExistsInProject:@"bigLetterPic.png"] && ([self fileExistsInProject:@"bigLetterPicWriting.png"]))
    {
        bigLetterPic = [CCSprite spriteWithFile:@"bigLetterPic.png"];
        bigLetterPicWriting = [CCSprite spriteWithFile:@"bigLetterPicWriting.png"];
